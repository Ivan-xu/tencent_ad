...
####    PATH
    ...
    path_train_csv='C:/Users/persp/workspace/GitHub/tencent_ad/data/train_cluster.csv'
    ...
    path_data_dtypes = 'C:/Users/persp/workspace/GitHub/tencent_ad/data/balance_data_dtypes.txt'
    path_data_hdf5='C:/Users/persp/workspace/GitHub/tencent_ad/data/balance_data_prepared_2.hdf5'
    path_balance_data_csv='C:/Users/persp/workspace/GitHub/tencent_ad/data/balance_data_prepared.csv'
...
#        timespent('data_merged tmp save')
	...
	if  os.path.exists(path_user_feature) and os.path.exists(path_user_feature_dtypes):
	    ...
	    mprint(len(user_feature),'len_user_feature')
