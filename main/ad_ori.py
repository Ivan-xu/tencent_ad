...
path_adFeature ='E:/MLfile/preliminary_contest_data/data/adFeature.csv'
...
ad_feature=pd.read_csv(path_adFeature)
if os.path.exists(path_user_feature):
    ...
    with open(path_userFeaturedata, 'r') as f:
        ...
        user_feature.to_csv(path_user_feature, index=False)
print ('user_feature is done!')
train=pd.read_csv(path_train_csv,nrows=100000)
predict=pd.read_csv(path_test1_csv,nrows =100000)
